class Admin::StoresController < Admin::ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @admin_store.save
        format.html { redirect_to admin_stores_path, notice: '新增通路成功' }
  ...
  def update
    respond_to do |format|
      if @admin_store.update(admin_store_params)
        format.html { redirect_to admin_stores_path, notice: '更新通路成功' }
  ...
  def destroy
    @admin_store.destroy
    respond_to do |format|
      format.html { redirect_to admin_stores_url, notice: '刪除通路成功' }
  ...
  private
    ...
    def admin_store_params
      params.require(:admin_store).permit(:name, :phone, :email, :address, :sort, :is_public, :area_id, :google_map_x, :google_map_y)
    end
end
