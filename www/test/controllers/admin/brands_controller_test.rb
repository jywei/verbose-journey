...
class Admin::BrandsControllerTest < ActionController::TestCase
  ...
  test "should create admin_brand" do
    assert_difference('Admin::Brand.count') do
      post :create, admin_brand: { content: @admin_brand.content, main_visual: @admin_brand.main_visual, name: @admin_brand.name }
    end
  ...
  test "should update admin_brand" do
    patch :update, id: @admin_brand, admin_brand: { content: @admin_brand.content, main_visual: @admin_brand.main_visual, name: @admin_brand.name }
    assert_redirected_to admin_brand_path(assigns(:admin_brand))
  end
