...
class Admin::NewsControllerTest < ActionController::TestCase
  ...
  test "should create admin_news" do
    assert_difference('Admin::News.count') do
      post :create, admin_news: { content: @admin_news.content, is_public: @admin_news.is_public, main_visual: @admin_news.main_visual, title: @admin_news.title }
    end
  ...
  test "should update admin_news" do
    patch :update, id: @admin_news, admin_news: { content: @admin_news.content, is_public: @admin_news.is_public, main_visual: @admin_news.main_visual, title: @admin_news.title }
    assert_redirected_to admin_news_path(assigns(:admin_news))
  end
