...
class Admin::StoresControllerTest < ActionController::TestCase
  ...
  test "should create admin_store" do
    assert_difference('Admin::Store.count') do
      post :create, admin_store: { address: @admin_store.address, email: @admin_store.email, is_public: @admin_store.is_public, name: @admin_store.name, phone: @admin_store.phone, sort: @admin_store.sort }
    end
  ...
  test "should update admin_store" do
    patch :update, id: @admin_store, admin_store: { address: @admin_store.address, email: @admin_store.email, is_public: @admin_store.is_public, name: @admin_store.name, phone: @admin_store.phone, sort: @admin_store.sort }
    assert_redirected_to admin_store_path(assigns(:admin_store))
  end
